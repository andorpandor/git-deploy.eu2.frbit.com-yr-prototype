...
current_member:
  ...
  is_admin: 'true'
get:
  path: /02-sist-besokte/01-oslo/page
post:
  page:
    yaml:
      status: live
    ...
    full_slug: 01-oslo
    type: none
    folder: /02-sist-besokte/01-oslo
    original_slug: 01-oslo
    original_datestamp: ""
    original_timestamp: ""
    original_numeric: ""
    fieldset: page-place
    meta:
      slug: 01-mysusæter skianlegg
    content: ""
  return: /yr.no/admin.php/pages?path=/02-sist-besokte
get_post:
  path: /02-sist-besokte/01-oslo/page
  page:
    yaml:
